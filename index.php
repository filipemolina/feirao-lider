			...
			<form action="includes/cadastro.php" method="post">
				...
				<div class="col-md-4">
					<div class="ent-prest">
						...
						<select class="form-entrada form-control" name="entrada">
						...
						<select class="form-prestacao form-control" name="prestacoes">
				...
				<span class="name-forms">Mensagem</span>
					<input type="text" class="msg form-control" name="mensagem"/>
				</div>
